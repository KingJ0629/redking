...
var url_ = "https://h5.ele.me/hongbao/?from=groupmessage&isappinstalled=0#hardware_id=&is_lucky_group=True&lucky_number=6&track_id=&platform=0&sn=2a07ca21489ea0c1&theme_id=3033&device_id=&refer_user_id=31257437";
...
(async () => {
  ...
  // console.log(await db.selectUserInfo('18858336290'))
	...
	// console.log(test('18858336290', url_))
})();
...
async function test(phone, url) {
	puppeteer.run(false, url, cookie, phone, callback)
}
exports.test = test